...
build_window_icon() {
  local window_status_icon_enable=$(get_tmux_option "@theme_window_status_icon_enable" "yes")

  local custom_icon_window_last=$(get_tmux_option "@theme_icon_window_last" "󰖰")
  local custom_icon_window_current=$(get_tmux_option "@theme_icon_window_current" "󰖯")
  local custom_icon_window_zoom=$(get_tmux_option "@theme_icon_window_zoom" "󰁌")
  local custom_icon_window_mark=$(get_tmux_option "@theme_icon_window_mark" "󰃀")
  local custom_icon_window_silent=$(get_tmux_option "@theme_icon_window_silent" "󰂛")
  local custom_icon_window_activity=$(get_tmux_option "@theme_icon_window_activity" "󰖲")
  local custom_icon_window_bell=$(get_tmux_option "@theme_icon_window_bell" "󰂞")
...
build_pane_format() {
  ...
  then
    if [ "$fill" = "none" ]
    then
      local show_left_separator="#[fg=$thm_surface_0,bg=$thm_base,nobold,nounderscore,noitalics]$pane_left_separator"
      local show_number="#[fg=$thm_text,bg=$thm_surface_0]$number"
      local show_middle_separator="#[fg=$thm_text,bg=$thm_surface_0,nobold,nounderscore,noitalics]$pane_middle_separator"
      local show_text="#[fg=$thm_text,bg=$thm_surface_0]$text"
      local show_right_separator="#[fg=$thm_surface_0,bg=$thm_base]$pane_right_separator"
    fi

    if [ "$fill" = "all" ]
    then
      local show_left_separator="#[fg=$color,bg=$thm_base,nobold,nounderscore,noitalics]$pane_left_separator"
      ...
      local show_right_separator="#[fg=$color,bg=$thm_base]$pane_right_separator"
    fi
    ...
    then
      ...
      local show_text="#[fg=$thm_text,bg=$background]$text"

      if [ "$pane_number_position" = "right" ]
      then
        local show_left_separator="#[fg=$background,bg=$thm_base,nobold,nounderscore,noitalics]$pane_left_separator"
        local show_right_separator="#[fg=$color,bg=$thm_base]$pane_right_separator"
      fi

      if [ "$pane_number_position" = "left" ]
      then
        local show_right_separator="#[fg=$background,bg=$thm_base,nobold,nounderscore,noitalics]$pane_right_separator"
        local show_left_separator="#[fg=$color,bg=$thm_base]$pane_left_separator"
      fi
...
build_window_format() {
  ...
  if [ "$fill" = "none" ]
  then
    local show_left_separator="#[fg=$thm_surface_0,bg=$thm_base,nobold,nounderscore,noitalics]$window_left_separator"
    local show_number="#[fg=$thm_text,bg=$thm_surface_0]$number"
    local show_middle_separator="#[fg=$thm_text,bg=$thm_surface_0,nobold,nounderscore,noitalics]$window_middle_separator"
    local show_text="#[fg=$thm_text,bg=$thm_surface_0]$text"
    local show_right_separator="#[fg=$thm_surface_0,bg=$thm_base]$window_right_separator"

  fi

  if [ "$fill" = "all" ]
  then
    local show_left_separator="#[fg=$color,bg=$thm_base,nobold,nounderscore,noitalics]$window_left_separator"
    local show_number="#[fg=$background,bg=$color]$number"
    local show_middle_separator="#[fg=$background,bg=$color,nobold,nounderscore,noitalics]$window_middle_separator"
    local show_text="#[fg=$background,bg=$color]$text"
    local show_right_separator="#[fg=$color,bg=$thm_base]$window_right_separator"
  ...
  then
    ...
    then
      local show_left_separator="#[fg=$background,bg=$thm_base,nobold,nounderscore,noitalics]$window_left_separator"
      local show_right_separator="#[fg=$color,bg=$thm_base]$window_right_separator"
    fi

    if [ "$window_number_position" = "left" ]
    then
      local show_right_separator="#[fg=$background,bg=$thm_base,nobold,nounderscore,noitalics]$window_right_separator"
      local show_left_separator="#[fg=$color,bg=$thm_base]$window_left_separator"
    fi
...
build_status_module() {
  ...
  then
    ...
    local show_right_separator="#[fg=$thm_surface_0,bg=$thm_base,nobold,nounderscore,noitalics]$status_right_separator"

    if [ "$status_connect_separator" = "yes" ]
    then
      local show_left_separator="#[fg=$color,bg=$thm_surface_0,nobold,nounderscore,noitalics]$status_left_separator"
      local show_right_separator="#[fg=$thm_surface_0,bg=$thm_surface_0,nobold,nounderscore,noitalics]$status_right_separator"
  ...
  if [ "$status_fill" = "all" ]
  then
    local show_left_separator="#[fg=$background,bg=$color,nobold,nounderscore,noitalics]$status_left_separator"

    local show_icon="#[fg=$color,bg=$background,nobold,nounderscore,noitalics]$icon "
...
main() {
  ...
  # module directories
  local custom_path="$(get_tmux_option "@theme_custom_plugin_dir" "${PLUGIN_DIR}/custom")"
  ...
  # messages
  set message-style "fg=${thm_sky},bg=${thm_surface_0},align=centre"
  set message-command-style "fg=${thm_sky},bg=${thm_surface_0},align=centre"

  # panes
  local pane_status_enable=$(get_tmux_option "@theme_pane_status_enabled" "no") # yes
  local pane_border_status=$(get_tmux_option "@theme_pane_border_status" "off") # bottom
  local pane_border_style=$(get_tmux_option "@theme_pane_border_style" "fg=${thm_surface_0}")
  local pane_active_border_style=$(get_tmux_option "@theme_pane_active_border_style" "fg=${thm_peach}")
  local pane_left_separator=$(get_tmux_option "@theme_pane_left_separator" "█")
  local pane_middle_separator=$(get_tmux_option "@theme_pane_middle_separator" "█")
  local pane_right_separator=$(get_tmux_option "@theme_pane_right_separator" "█")
  local pane_number_position=$(get_tmux_option "@theme_pane_number_position" "left") # right, left
  ...
  local window_left_separator=$(get_tmux_option "@theme_window_left_separator" "█")
  local window_right_separator=$(get_tmux_option "@theme_window_right_separator" "█")
  local window_middle_separator=$(get_tmux_option "@theme_window_middle_separator" "█ ")
  local window_number_position=$(get_tmux_option "@theme_window_number_position" "left") # right, left
  local window_status_enable=$(get_tmux_option "@theme_window_status_enable" "no") # right, left
  ...
  local status_bg=$(get_tmux_option "theme_status_bg" "${thm_mantle}")
  local status_left_separator=$(get_tmux_option "@theme_status_left_separator" "")
  ...
  local status_modules_left=$(get_tmux_option "@theme_status_modules_left" "")
  ...
  setw mode-style "fg=${thm_pink} bg=${thm_surface_2} bold"
